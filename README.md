# ⚡ Dimmer Lampu & Motor AC Deteksi Zero-Crossing ESP32
...
Pengatur intensitas cahaya lampu dan kecepatan motor AC fasa tunggal menggunakan modul TRIAC dengan sinkronisasi interupsi Zero-Crossing optocoupler.
...
1. Buka file **`esp32-ac-dimmer-zero-crossing.ino`** menggunakan **Arduino IDE 2.0+** atau PlatformIO.
